...
- [ ] [LSTM – Christopher Olah’s blog Understanding LSTM Networks  and R2Rt.com Written Memories: Understanding, Deriving and Extending the LSTM](https://colah.github.io/posts/2015-08-Understanding-LSTMs/)
...
- [ ] [Attention – Christopher Olah Attention and Augmented Recurrent Neural Networks](https://distill.pub/2016/augmented-rnns/)
...
- [ ] [Seq2Seq - Nathan Lintz Sequence Modeling With Neural Networks](https://indico.io/blog/sequence-modeling-neuralnets-part1/)
...
- [ ] [Transformer Google Blog](https://ai.googleblog.com/2017/08/transformer-novel-neural-network.html)
    Need for transformer: Recurrent models due to sequential nature (computations focused on the position of symbol in input and output) are not allowing for parallelization along training, thus have a problem with learning long-term dependencies from memory. 
